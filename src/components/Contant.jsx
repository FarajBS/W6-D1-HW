...
export default function Contant(props) {
    return (
        <>
            <div>
                <div className="absolute top-0 left-0 bg-black w-screen h-screen opacity-90 flex items-start sm:justify-center sm:items-center">
            ...
            <div className="w-screen flex flex-row flex-wrap gap-4 absolute pb-5 bottom-0 left-0 justify-center items-center">
                <Link to="/html">
                    <div className="bg-gray-800 p-5 rounded-2xl hover:bg-gray-950">
